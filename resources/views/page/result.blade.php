    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <ul class="booking-list">
                @foreach($result['PricedItineraries'] as $key => $val)
                <li>
                    <div class="booking-item-container">
                        <div class="booking-item">
                            <div class="row">
                                ...
                                <!-- $val['PTC_FareBreakdowns']['PTC_FareBreakdown']['PassengerFare']['FareConstruction']['Amount']  -->
                                <div class="col-md-3"><span class="booking-item-price"><?php echo $val->AirItineraryPricingInfo->PTC_FareBreakdowns->PTC_FareBreakdown->PassengerFare->FareConstruction->Amount;?></span><span>/person</span>
